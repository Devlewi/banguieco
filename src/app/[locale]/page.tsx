...
export async function generateMetadata({
  ...
  return {
    title: locale === "en" ? "BANGUI ECO | HOME" : "BANGUI ECO | ACCUEIL",
    description:
      locale === "en"
        ? "BANGUI ECO is your economic news portal dedicated to the Central African Republic"
        : "BANGUI ECO est votre portail d'information économique dédié à la République Centrafricaine",
    ...
    openGraph: {
      ...
      description:
        locale === "en"
          ? "BANGUI ECO is your economic news portal dedicated to the Democratic Republic of the Congo"
          : "BANGUI ECO est votre portail d'information économique dédié à la République Démocratique du Congo",
