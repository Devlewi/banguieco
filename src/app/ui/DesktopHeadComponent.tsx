...
const villeAleatoire = villesRCA[Math.floor(Math.random() * villesRCA.length)];
  ...
  const options: Intl.DateTimeFormatOptions = {
    ...
    month: "long",
    year: "numeric",
    timeZone: "Africa/Bangui", // Fuseau horaire RCA (UTC+1)
  };
    ...
    <>
      <Head>
        <link
          rel="preload"
          as="image"
          href={`/${locale}/images/banner-centrafrique.webp`}
          type="image/webp"
...
>
        ...
        <div
          ...
          style={{
            background: `url(/${locale}/images/banner-centrafrique.webp) center center / cover no-repeat`,
                  ...
                  <ul id="menu-top-links" className="menu">
                    ...
                    >
                      <a href="#" style={{ fontWeight: 900, fontSize: 15 }}>
                        <img
                          src={`/${locale}/images/flag-centrafrique.webp`}
                          style={{ width: "20%" }}
          ...
          <div className="inner full">
            ...
            <div className="items items-center ">
              ...
              >
                <h1>
                  <img
                    src={`/${locale}/images/logo-centrafrique-eco.webp`}
                    className="logo-image logo-image-dark"
                    alt=""
                    srcSet={`/${locale}/images/logo-centrafrique-eco.webp`}
                  />
